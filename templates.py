...
comments = {
    ...
    construction and evaluation.  NAME has demonstrated excellent skill and understanding in the first two parts. THIRD_PERSON_SINGULAR_PRONOUN is learning and applying the PHP programming language 
    ...
    improve GENDER_THIRD_PERSON knowledge and understanding by asking for help more often, independently attempting difficult 
    coding projects and seeking ways to add complexity to GENDER_THIRD_PERSON projects. Designing solutions is incredibly 
    challenging and rewarding.  NAME should continue to push THIRD_PERSON_PLURAL_GENDER to computationally solve problems by 
    independently attempting to code, solving problem-sets, and computational thinking.'''
